...
function notion(cardId) {
  const notionIcon = document.querySelector(`#notion${cardId?cardId:0}`);
  if (notionIcon) {
    notionIcon.src = "./assets/filled-notion.png";
  }
}

function notionRemove(cardId) {
  const notionIcon = document.querySelector(`#notion${cardId?cardId:0}`);
  if (notionIcon) {
    notionIcon.src = "./assets/notion.png";
  }
}